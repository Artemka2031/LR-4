...
def register_user():
    while True:
        ...
        if not (has_repeating_characters(password) and is_valid_password(password)):
            print("Ошибка регистрации. Пароль должен состоять из 5 символов, включая циф1ры и знаки арифметических "
                  "операций.")
...
def change_password(user):
    ...
    if not (has_repeating_characters(new_password) and is_valid_password(new_password)):
